...
TEST(Array, emplace_at_to_ref_can_move_construct_non_bitwise_move_constructible_type)
{
    ...
    // Emplace at the end of empty array
    {
        // Reallocation
        {
            ...
            // Emplace first element
            const Type& first_element = array.emplace_at_to_ref(array.count(), move(first_element_to_move));
            ...
            // Emplace second element
            const Type& second_element = array.emplace_at_to_ref(array.count(), move(second_element_to_move));
        ...
        // No reallocation
        {
            ...
            // Emplace first element
            const Type& first_element = array.emplace_at_to_ref(0, move(first_element_to_move));
            ...
            // Emplace second element
            const Type& second_element = array.emplace_at_to_ref(1, move(second_element_to_move));
    ...
    // Emplace at the middle of an array
    {
        // Reallocation
        {
            ...
            // Emplace first element
            const Type& mid_element = array.emplace_at_to_ref(array.count() / 2u, move(first_element_to_move));
    ...
    // Emplace at the begin of an array
    {
        // Reallocation
        {
            ...
            // Emplace second element
            const Type& second_element = array.emplace_at_to_ref(0, move(second_element_to_move));
