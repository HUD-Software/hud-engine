...
TEST(SharedPointer_array_not_safe, copy_assignement_an_empty_same_type) {
    ...
    const auto test = []() {
        ...
        const SharedPointer<HUD_TEST::NonBitwiseType[2]> empty;
        shared_ptr = empty;
...
TEST(SharedPointer_array_not_safe, move_assignement_same_type) {
    ...
    const auto test = []() {
        ...
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr;
        shared_ptr = move(shared_ptr_to_move);
        return std::tuple{
...
TEST(SharedPointer_array_not_safe, move_assignement_different_type) {
    ...
    const auto test = []() {
        ...
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr_to_move(type);
        SharedPointer<const HUD_TEST::NonBitwiseType[2]> shared_ptr;
        shared_ptr = move(shared_ptr_to_move);
...
TEST(SharedPointer_array_not_safe, move_assignement_an_empty_same_type) {
    ...
    const auto test = []() {
        ...
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr(type);
        SharedPointer<HUD_TEST::NonBitwiseType[2]> empty;
