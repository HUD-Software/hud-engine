...
TEST(SharedPointer_array_not_safe, param_constructor_nullptr) {
    ...
    const auto test = []()
    {
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr(nullptr);
        return std::tuple{
            shared_ptr.pointer() == nullptr,
            shared_ptr.shared_count()
        };
...
TEST(SharedPointer_array_not_safe, param_constructor_same_type) {
    ...
    const auto test = []() {
        ...
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr(type);
        return std::tuple{
...
TEST(SharedPointer_array_not_safe, param_constructor_different_type) {
    ...
    const auto test = []() {
        i32 dtor_count[2] = { 0,0 };
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<const HUD_TEST::NonBitwiseType[2]> shared_ptr(type);
        return std::tuple{
            shared_ptr.pointer() == type,
            shared_ptr.shared_count() == 1u,
            shared_ptr.pointer()[0].id() == 1,
...
TEST(SharedPointer_array_not_safe, copy_constructor_same_type) {
    ...
    const auto test = []() {
        i32 dtor_count[2] = { 0,0 };
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        const SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr_to_copy(type);
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr(shared_ptr_to_copy);
...
TEST(SharedPointer_array_not_safe, copy_constructor_different_type) {
    ...
    const auto test = []() {
        ...
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        const SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr_to_copy(type);
        SharedPointer<const HUD_TEST::NonBitwiseType[2]> shared_ptr(shared_ptr_to_copy);
...
TEST(SharedPointer_array_not_safe, move_constructor_same_type) {
    ...
    const auto test = []() {
        i32 dtor_count[2] = { 0,0 };
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr_to_move(type);
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr(move(shared_ptr_to_move));
...
TEST(SharedPointer_array_not_safe, move_constructor_different_type) {
    ...
    const auto test = []() {
        ...
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType[2]{ {1, &dtor_count[0]},{2, &dtor_count[1]} };
        SharedPointer<HUD_TEST::NonBitwiseType[2]> shared_ptr_to_move(type);
        SharedPointer<const HUD_TEST::NonBitwiseType[2]> shared_ptr(move(shared_ptr_to_move));
