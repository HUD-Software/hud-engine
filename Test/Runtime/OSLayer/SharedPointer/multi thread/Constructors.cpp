...
TEST(SharedPointer_safe, default_constructor) {
    ...
    const auto test = []()
    {
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr;
        return std::tuple{
...
TEST(SharedPointer_safe, param_constructor_nullptr) {
    ...
    const auto test = []()
    {
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(nullptr);
        return std::tuple{
            shared_ptr.pointer() == nullptr,
            shared_ptr.shared_count()
        };
...
TEST(SharedPointer_safe, param_constructor_same_type) {
    ...
    const auto test = [](i32 id) {
        ...
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(type);
        return std::tuple{
...
TEST(SharedPointer_safe, copy_constructor_same_type) {
    ...
    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType(id, &dtor_count);
        const SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr_to_copy(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(shared_ptr_to_copy);
...
TEST(SharedPointer_safe, copy_constructor_different_type) {
    ...
    const auto test = [](i32 id) {
        ...
        HUD_TEST::NonBitwiseType2* type = new HUD_TEST::NonBitwiseType2(id, &dtor_count);
        const SharedPointer<HUD_TEST::NonBitwiseType2, EThreadSafety::safe> shared_ptr_to_copy(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(shared_ptr_to_copy);
...
TEST(SharedPointer_safe, move_constructor_same_type) {
    ...
    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType(id, &dtor_count);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr_to_move(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(move(shared_ptr_to_move));
...
TEST(SharedPointer_safe, move_constructor_different_type) {
    ...
    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        HUD_TEST::NonBitwiseType2* type = new HUD_TEST::NonBitwiseType2(id, &dtor_count);
        SharedPointer<HUD_TEST::NonBitwiseType2, EThreadSafety::safe> shared_ptr_to_move(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(move(shared_ptr_to_move));
