...
TEST(SharedPointer_safe, copy_assignement_an_empty_same_type) {
    ...
    const auto test = [](i32 id) {
        ...
        const SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> empty;
        shared_ptr = empty;
        return std::tuple{
...
TEST(SharedPointer_safe, move_assignement_same_type) {
    ...
    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType(id, &dtor_count);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr_to_copy(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr;
...
TEST(SharedPointer_safe, move_assignement_different_type) {
    ...
    const auto test = [](i32 id) {
        i32 dtor_count = 0;
        HUD_TEST::NonBitwiseType2* type = new HUD_TEST::NonBitwiseType2(id, &dtor_count);
        SharedPointer<HUD_TEST::NonBitwiseType2, EThreadSafety::safe> shared_ptr_to_copy(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr;
        shared_ptr = move(shared_ptr_to_copy);
        return std::tuple{
            shared_ptr_to_copy.pointer() == nullptr,
...
TEST(SharedPointer_safe, move_assignement_an_empty_same_type) {
    ...
    const auto test = [](i32 id) {
        ...
        HUD_TEST::NonBitwiseType* type = new HUD_TEST::NonBitwiseType(id, &dtor_count);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> shared_ptr(type);
        SharedPointer<HUD_TEST::NonBitwiseType, EThreadSafety::safe> empty;
